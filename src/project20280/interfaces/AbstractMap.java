...
public abstract class AbstractMap<K, V> implements Map<K, V> {
  ...
  // { "apple" -> 10, "banana" -> 5, "orange" -> 8 } becomes now : ["apple",
  // "banana", "orange"] (after applying keySet)
  ...
  /*
   * Similar to keySet(), entrySet() returns an iterable of key-value pairs, and
   * the ValueIterator extracts only the values from these entries.
   */
  // { "apple" -> 10, "banana" -> 5, "orange" -> 8 } -> [10, 5, 8] (after values
  // method)
}
